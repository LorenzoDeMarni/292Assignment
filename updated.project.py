...
# List of datasets
raw_dfs = {
    "lorenzo_walking": pd.read_csv("lorenzo_walking_raw.csv"),
    "lorenzo_jumping": pd.read_csv("lorenzo_jumping_raw.csv"),
    "kaykay_walking": pd.read_csv("kaykay_walking_raw.csv"),
    "kaykay_jumping": pd.read_csv("kaykay_jumping_raw.csv"),
    "daniil_walking": pd.read_csv("daniil_walking_raw.csv"),
    "daniil_jumping": pd.read_csv("daniil_jumping_raw.csv")
}
...
#Lorenzo Walking acceleration data
ax1.plot(raw_dfs['lorenzo_walking']['Time (s)'], raw_dfs['lorenzo_walking']['Linear Acceleration x (m/s^2)'], 'k-',
         alpha=0.7, label='Raw X-axis')
ax1.plot(raw_dfs['lorenzo_walking']['Time (s)'], raw_dfs['lorenzo_walking']['Linear Acceleration y (m/s^2)'], 'k-',
         alpha=0.7, label='Raw Y-axis')
ax1.plot(raw_dfs['lorenzo_walking']['Time (s)'], raw_dfs['lorenzo_walking']['Linear Acceleration z (m/s^2)'], 'k-',
         alpha=0.7, label='Raw Z-axis')
ax1.plot(processed_dfs['lorenzo_walking']['Time (s)'],
         processed_dfs['lorenzo_walking']['Linear Acceleration x (m/s^2)'], 'r-', label='Filtered X-axis')
ax1.plot(processed_dfs['lorenzo_walking']['Time (s)'],
         processed_dfs['lorenzo_walking']['Linear Acceleration y (m/s^2)'], 'b-', label='Filtered Y-axis')
ax1.plot(processed_dfs['lorenzo_walking']['Time (s)'],
         processed_dfs['lorenzo_walking']['Linear Acceleration z (m/s^2)'], 'y-', label='Filtered Z-axis')
...
#Lorenzo Jumping acceleration data
ax2.plot(raw_dfs['lorenzo_jumping']['Time (s)'], raw_dfs['lorenzo_jumping']['Linear Acceleration x (m/s^2)'], 'k-',
         alpha=0.7, label='Raw X-axis')
ax2.plot(raw_dfs['lorenzo_jumping']['Time (s)'], raw_dfs['lorenzo_jumping']['Linear Acceleration y (m/s^2)'], 'k-',
         alpha=0.7, label='Raw Y-axis')
ax2.plot(raw_dfs['lorenzo_jumping']['Time (s)'], raw_dfs['lorenzo_jumping']['Linear Acceleration z (m/s^2)'], 'k-',
         alpha=0.7, label='Raw Z-axis')
ax2.plot(processed_dfs['lorenzo_jumping']['Time (s)'],
         processed_dfs['lorenzo_jumping']['Linear Acceleration x (m/s^2)'], 'r-', label='Filtered X-axis')
ax2.plot(processed_dfs['lorenzo_jumping']['Time (s)'],
         processed_dfs['lorenzo_jumping']['Linear Acceleration y (m/s^2)'], 'b-', label='Filtered Y-axis')
ax2.plot(processed_dfs['lorenzo_jumping']['Time (s)'],
         processed_dfs['lorenzo_jumping']['Linear Acceleration z (m/s^2)'], 'y-', label='Filtered Z-axis')
...
ax1.plot(raw_dfs['kaykay_walking']['Time (s)'], raw_dfs['kaykay_walking']['Linear Acceleration x (m/s^2)'], 'k-',
         alpha=0.7, label='Raw X-axis')
ax1.plot(raw_dfs['kaykay_walking']['Time (s)'], raw_dfs['kaykay_walking']['Linear Acceleration y (m/s^2)'], 'k-',
         alpha=0.7, label='Raw Y-axis')
ax1.plot(raw_dfs['kaykay_walking']['Time (s)'], raw_dfs['kaykay_walking']['Linear Acceleration z (m/s^2)'], 'k-',
         alpha=0.7, label='Raw Z-axis')
ax1.plot(processed_dfs['kaykay_walking']['Time (s)'],
         processed_dfs['kaykay_walking']['Linear Acceleration x (m/s^2)'], 'r-', label='Filtered X-axis')
ax1.plot(processed_dfs['kaykay_walking']['Time (s)'],
         processed_dfs['kaykay_walking']['Linear Acceleration y (m/s^2)'], 'b-', label='Filtered Y-axis')
ax1.plot(processed_dfs['kaykay_walking']['Time (s)'],
         processed_dfs['kaykay_walking']['Linear Acceleration z (m/s^2)'], 'y-', label='Filtered Z-axis')
ax1.set_title('Walking')
ax1.set_xlabel('Time (s)')
ax1.set_ylabel('Acceleration (m/s²)')
ax1.grid(True)
...
# KayKay Jumping acceleration data
ax2.plot(raw_dfs['kaykay_jumping']['Time (s)'], raw_dfs['kaykay_jumping']['Linear Acceleration x (m/s^2)'], 'k-',
         alpha=0.7, label='Raw X-axis')
ax2.plot(raw_dfs['kaykay_jumping']['Time (s)'], raw_dfs['kaykay_jumping']['Linear Acceleration y (m/s^2)'], 'k-',
         alpha=0.7, label='Raw Y-axis')
ax2.plot(raw_dfs['kaykay_jumping']['Time (s)'], raw_dfs['kaykay_jumping']['Linear Acceleration z (m/s^2)'], 'k-',
         alpha=0.7, label='Raw Z-axis')
ax2.plot(processed_dfs['kaykay_jumping']['Time (s)'],
         processed_dfs['kaykay_jumping']['Linear Acceleration x (m/s^2)'], 'r-', label='Filtered X-axis')
ax2.plot(processed_dfs['kaykay_jumping']['Time (s)'],
         processed_dfs['kaykay_jumping']['Linear Acceleration y (m/s^2)'], 'b-', label='Filtered Y-axis')
ax2.plot(processed_dfs['kaykay_jumping']['Time (s)'],
         processed_dfs['kaykay_jumping']['Linear Acceleration z (m/s^2)'], 'y-', label='Filtered Z-axis')
ax2.set_title('Jumping')
ax2.set_xlabel('Time (s)')
ax2.set_ylabel('Acceleration (m/s²)')
ax2.grid(True)
...
# Figure 3: Daniil's data (walking and jumping in one window)
fig_daniil, (ax1, ax2) = plt.subplots(2, 1, figsize=(10, 8))
fig_daniil.suptitle('Daniil Data - Acceleration Processing', fontsize=16)

ax1.plot(raw_dfs['daniil_walking']['Time (s)'], raw_dfs['daniil_walking']['Linear Acceleration x (m/s^2)'], 'k-',
         alpha=0.7, label='Raw X-axis')
ax1.plot(raw_dfs['daniil_walking']['Time (s)'], raw_dfs['daniil_walking']['Linear Acceleration y (m/s^2)'], 'k-',
         alpha=0.7, label='Raw Y-axis')
ax1.plot(raw_dfs['daniil_walking']['Time (s)'], raw_dfs['daniil_walking']['Linear Acceleration z (m/s^2)'], 'k-',
         alpha=0.7, label='Raw Z-axis')
ax1.plot(processed_dfs['daniil_walking']['Time (s)'],
         processed_dfs['daniil_walking']['Linear Acceleration x (m/s^2)'], 'r-', label='Filtered X-axis')
ax1.plot(processed_dfs['daniil_walking']['Time (s)'],
         processed_dfs['daniil_walking']['Linear Acceleration y (m/s^2)'], 'b-', label='Filtered Y-axis')
ax1.plot(processed_dfs['daniil_walking']['Time (s)'],
         processed_dfs['daniil_walking']['Linear Acceleration z (m/s^2)'], 'y-', label='Filtered Z-axis')
ax1.set_title('Walking')
ax1.set_xlabel('Time (s)')
ax1.set_ylabel('Acceleration (m/s²)')
ax1.grid(True)
...
# Daniil Jumping acceleration data
ax2.plot(raw_dfs['daniil_jumping']['Time (s)'], raw_dfs['daniil_jumping']['Linear Acceleration x (m/s^2)'], 'k-',
         alpha=0.7, label='Raw X-axis')
ax2.plot(raw_dfs['daniil_jumping']['Time (s)'], raw_dfs['daniil_jumping']['Linear Acceleration y (m/s^2)'], 'k-',
         alpha=0.7, label='Raw Y-axis')
ax2.plot(raw_dfs['daniil_jumping']['Time (s)'], raw_dfs['daniil_jumping']['Linear Acceleration z (m/s^2)'], 'k-',
         alpha=0.7, label='Raw Z-axis')
ax2.plot(processed_dfs['daniil_jumping']['Time (s)'],
         processed_dfs['daniil_jumping']['Linear Acceleration x (m/s^2)'], 'r-', label='Filtered X-axis')
ax2.plot(processed_dfs['daniil_jumping']['Time (s)'],
         processed_dfs['daniil_jumping']['Linear Acceleration y (m/s^2)'], 'b-', label='Filtered Y-axis')
ax2.plot(processed_dfs['daniil_jumping']['Time (s)'],
         processed_dfs['daniil_jumping']['Linear Acceleration z (m/s^2)'], 'y-', label='Filtered Z-axis')
ax2.set_title('Jumping')
ax2.set_xlabel('Time (s)')
ax2.set_ylabel('Acceleration (m/s²)')
ax2.grid(True)
...
if (round(lorenzo_sampling_rate / 50) * 50) == (round(kaykay_sampling_rate / 50) * 50) == (
        round(daniil_sampling_rate / 50) * 50):
...
# Function to create a DataFrame with column names

def features_to_dataframe(features_list):
    # Define the axes
    axes = ['x', 'y', 'z', 'abs']

    # Create column names in the format feature_axis
    columns = []
...
# Create final dataset with activity column (0 for walking, 1 for jumping) 
...
fig_kaykay_seg, axes = plt.subplots(1, 2, figsize=(15, 5))
fig_kaykay_seg.suptitle('KayKay\'s Segmented Data (first 5 seconds)', fontsize=16)
# Create a time axis for a single 5-second segment
time_axis = np.linspace(0, 5, int(window_size), endpoint=False)  # From 0 to 5 seconds
...
# Plot KayKay's Walking segmented data with all acceleration axes
ax1.plot(time_axis, segmented_arrays['kaykay_walking'][0, :, 0], 'r-', label='X-axis')
ax1.plot(time_axis, segmented_arrays['kaykay_walking'][0, :, 1], 'b-', label='Y-axis')
ax1.plot(time_axis, segmented_arrays['kaykay_walking'][0, :, 2], 'y-', label='Z-axis')
...
# Plot KayKay's Jumping segmented data with all acceleration axes
ax2.plot(time_axis, segmented_arrays['kaykay_jumping'][0, :, 0], 'r-', label='X-axis')
ax2.plot(time_axis, segmented_arrays['kaykay_jumping'][0, :, 1], 'b-', label='Y-axis')
ax2.plot(time_axis, segmented_arrays['kaykay_jumping'][0, :, 2], 'y-', label='Z-axis')
...
fig_daniil_seg, axes = plt.subplots(1, 2, figsize=(15, 5))
fig_daniil_seg.suptitle('Daniil\'s Segmented Data (first 5 seconds)', fontsize=16)
...
# Plot Daniil's Walking segmented data with all acceleration axes
ax1.plot(time_axis, segmented_arrays['daniil_walking'][0, :, 0], 'r-', label='X-axis')
ax1.plot(time_axis, segmented_arrays['daniil_walking'][0, :, 1], 'b-', label='Y-axis')
ax1.plot(time_axis, segmented_arrays['daniil_walking'][0, :, 2], 'y-', label='Z-axis')
ax1.set_title('Daniil Walking')
ax1.set_xlabel('Time (s)')
ax1.set_ylabel('Acceleration (m/s²)')
ax1.legend()
ax1.grid(True)

# Plot Daniil's Jumping segmented data with all acceleration axes
ax2.plot(time_axis, segmented_arrays['daniil_jumping'][0, :, 0], 'r-', label='X-axis')
ax2.plot(time_axis, segmented_arrays['daniil_jumping'][0, :, 1], 'b-', label='Y-axis')
ax2.plot(time_axis, segmented_arrays['daniil_jumping'][0, :, 2], 'y-', label='Z-axis')
ax2.set_title('Daniil Jumping')
ax2.set_xlabel('Time (s)')
ax2.set_ylabel('Acceleration (m/s²)')
ax2.legend()
ax2.grid(True)
