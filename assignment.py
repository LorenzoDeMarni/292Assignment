...
ax1.plot(lorenzo_walking_df['Time (s)'], lorenzo_walking_df['Filtered Absolute acceleration (m/s^2)'], 'g-', label='Filtered Walking')
...
ax2.plot(lorenzo_jumping_df['Time (s)'], lorenzo_jumping_df['Filtered Absolute acceleration (m/s^2)'], 'g-', label='Filtered Jumping')
...
ax3.plot(kaykay_walking_df['Time (s)'], kaykay_walking_df['Filtered Absolute acceleration (m/s^2)'], 'g-', label='Filtered Walking')
...
ax4.plot(kaykay_jumping_df['Time (s)'], kaykay_jumping_df['Filtered Absolute acceleration (m/s^2)'], 'g-', label='Filtered Jumping')
